			...
			<div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
				<div class="panel border bg-white">
					<div class="panel-heading">
						<h3 class="pt-3 font-weight-bold">Đăng ký</h3>
					</div>
					<div class="panel-body p-3">
						<form action="dangky" method="get">
							...
							<div class="form-group py-2">
								<div class="input-field">
									<input name="fullname" type="text" placeholder="Nhập họ tên" required>
								</div>
							</div>
							<div class="form-group py-2">
								<div class="input-field">
							...
							<div class="form-group py-2">
								<div class="input-field">
									<input name="email" style="border: none;" type="text"
										placeholder="Nhập email" required>
								</div>
							</div>
							<button class="btn btn-primary btn-block mt-3" type="submit" name="dangky" value="s">Đăng ký</button>
