...
<body>
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		<!-- Navbar Brand-->
		<a class="navbar-brand ps-3" href="trangchu">Quản lý</a>
		<!-- Sidebar Toggle-->
					...
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="hang">Hãng</a> 
			...
			<main>
				<div class="container">
					<div class="d-flex justify-content-between mt-4">
						...
						<form action="themdienthoai" id="hangform" method="post">
							<button class="btn btn-primary" type="submit" name="them"
					...
					<table class="table table-striped table-hover">
						...
						<tbody class="table table-striped table-hover">
							<c:forEach var="dt" items="${dienthoai}">
								<tr>
									<td>${count}</td>
									<td>${dt.getTenDienThoai()}</td>
									<td>${dt.getSoLuong()}</td>
									<td>${dt.getGia()}đ</td>
									<td>${dt.getNgayNhap()}</td>
									<td>${dt.getRam()}GB</td>
									<td>${dt.getDungLuong()}GB</td>
									<td>${dt.getKichThuoc()}inch</td>
									<td><img style="max-width: 200px;" alt=""
										src="../${dt.getAnh()}"></td>
									<td><a href="suadienthoai?ma=${dt.getMaDienThoai()}"> <img
											style="width: 20px; height: 20px;" alt=""
											src="../icons/edit.png">
									</a></td>
									<td><a href="dienthoai?xoa=${dt.getMaDienThoai()}"> <img
											style="width: 20px; height: 20px;" alt=""
											src="../icons/delete.jpg">
									</a></td>
								</tr>
