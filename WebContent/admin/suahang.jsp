				...
				<div class="container px-4">
					<section class="panel panel-default mt-4">
						<div class="panel-heading">
							<h3 class="panel-title">Sửa hãng</h3>
						</div>
						<div class="panel-body">

							<form action="suahang" class="form-horizontal" role="form"
								method="post">
								...
								<div class="form-group mb-3">
									<label for="name" class="col-sm-3 control-label">Mã
										hãng</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="mahang" id="name"
											placeholder="Nhập mã hãng" value="${s.getMaHang()}" readonly="readonly">
									</div>
								</div>
								...
								<div class="form-group mb-3">
									<label for="name" class="col-sm-3 control-label">Tên
										hãng</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="tenhang" id="name"
