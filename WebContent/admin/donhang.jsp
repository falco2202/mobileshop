						...
						<tbody class="table table-striped table-hover">
							<c:forEach var="dh" items="${donhang}">
								<tr>
									...
									<td>
										<a href="chitietdonhang?ma=${dh.getMaHoaDon()}"> <img style="width: 30px; height: 30px; text-align: center;" alt="" src="../icons/detail.png"> </a>
									</td>
									<td>
										<a href="donhang?xacnhan=${dh.getMaHoaDon()}"> <img style="width: 30px; height: 30px;" alt="" src="../icons/accept.png"> </a>
									</td>
								</tr>
