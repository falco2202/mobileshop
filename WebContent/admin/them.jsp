				...
				<div class="container px-4">
					<section class="panel panel-default mt-4">
						...
						<div class="panel-body">
							...
							<form action="designer-finish.html" class="form-horizontal"
								role="form">
								...
								<!-- form-group // -->
								<div class="form-group mb-3">
									<label for="name" class="col-sm-3 control-label">Название
										продукта</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" name="name" id="name"
								...
								<div class="form-group mb-3">
									...
									<div class="col-sm-3">
										<label class="control-label small" for="date_start">Начало:
										</label> <input type="text" class="form-control" name="date_start"
											id="date_start" placeholder="Начало">
									</div>
									<div class="col-sm-3">
										<label class="control-label small" for="date_finish">Конец:</label>
										<input type="text" class="form-control" name="date_finish"
											id="date_finish" placeholder="Конец">
									</div>
								</div>
								<!-- form-group // -->
								<div class="form-group mb-4">
									...
									<input type="file"
										class="form-control col-lg-offset-3" name="anh"
								...
								<div class="form-group">
									<div class="col-sm-offset-3 col-sm-9">
										<input type="hidden" id="anhSach" name="anh" /> <img
											id="Photo" src="" class="img img-bordered"
											style="width: 250px" />
									</div>
								</div>
								<!-- form-group // -->
