			...
			<main>
				<div class="container">
					<div class="d-flex justify-content-between mt-4">
						...
						<form action="themhang" id="hangform" method="post">
						...
						<tbody class="table table-striped table-hover">
							<c:forEach var="h" items="${hang}">
								<tr>
									...
									<td>${h.getMaHang()}</td>
									<td>${h.getTenHang()}</td>
									<td><a href="suahang?ma=${h.getMaHang()}"> <img style="width: 20px; height: 20px;" alt="" src="../icons/edit.png"> </a></td>
									<td><a href="hang?xoa=${h.getMaHang()}"> <img style="width: 20px; height: 20px;" alt="" src="../icons/delete.jpg"> </a></td>
								</tr>
